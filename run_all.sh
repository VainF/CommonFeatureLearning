...
# Train
# ResNet34
python amal.py --gpu_id 3 --model resnet34 --lr 1e-4 --cfl_lr 5e-4
...
# ResNet50
#python amal.py --gpu_id 3 --model resnet50 --lr 2e-5 --cfl_lr 2e-4
#python kd.py --gpu_id 3 --model resnet50 --lr 2e-5
...
# DenseNet121
#python amal.py --gpu_id 3 --model densenet121 --lr 2e-4 --cfl_lr 2e-3
